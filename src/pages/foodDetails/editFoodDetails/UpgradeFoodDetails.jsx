...
function UpgradeFoodDetails({
  upgradeFoodDetailsID,
  price,
  onSelectedUpgradeFood,
}) {
  const checkPrice = price ? price : 0;

  const [selectedValues, setSelectedValues] = useState(
    upgradeFoodDetailsID.map((item) => item.upgrade_food_details_id)
  );
