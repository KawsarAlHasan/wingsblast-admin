...
function AddFishChoice({ refetch }) {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      const response = await API.post("/fish-choice/create", formData); // Updated endpoint
      message.success("Fish Choice added successfully!");
      refetch();
      handleCancel(); // Close modal on success
    } catch (error) {
      message.error("Failed to add Fish Choice. Try again.");
    } finally {
      setLoading(false);
    }
  };
