...
function Test() {
  const preveusData = 1; // initial value
  const [isChecked, setIsChecked] = useState(preveusData); // state ম্যানেজ

  const onChange = (e) => {
    setIsChecked(e.target.checked); // ইউজার চ্যাঞ্জ করলে সেট করে
