    ...
    <div className="container mx-auto px-4 py-8">
      ...
      >
        <div>
          ...
          <div className="mb-6">
            <h4 className="text-lg font-semibold mb-3">Discount Information</h4>
          ...
          {/* Time Information */}
          <div className="mb-6">
            <h4 className="text-lg font-semibold mb-3">Others Information</h4>
